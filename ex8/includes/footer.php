	...
	<div class="menu">
		...
		<a href="http://localhost./redirect_to_sdkwebs.php">SDKWebs</a> |
		<a href="logout.php?xsrf_dynamic=<?=urlencode($xsrf_dynamic)?>&xsrf_signed=<?=urlencode($xsrf_signed)?>">Изход</a>
	</div>
	<div class="lsidebar">
		<?php
